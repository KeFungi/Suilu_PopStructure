...
fit_model.add_time_param("ti2", t0=params["ti2"])
...
fit_model.add_time_param("tp", t0=params["tp"], upper_constraints=["ti1","ti2"])
fit_model.add_pulse_param("p12", p0=params["p12"], upper=0.5)
