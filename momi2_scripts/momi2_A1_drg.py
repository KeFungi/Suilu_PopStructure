...
fit_model.add_size_param("Ng", N0=N0_neutral)
fit_model.add_time_param("tg", t0=t_intro*5)
...
fit_model.move_lineages(pop, "ghost", t="ti", N="Ng", g=0)
fit_model.move_lineages("CEu-Belgium", "ghost", t="tg")
